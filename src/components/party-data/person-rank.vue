		...
		<div class="mui-content">
			...
			<div id="slider" class="mui-slider mui-fullscreen bottom1_3">
				<div id="sliderSegmentedControl" class="mui-slider-indicator mui-segmented-control mui-segmented-control-inverted">
					<a class="mui-control-item mui-active" href="#item1mobile">个人排名</a>
					<a class="mui-control-item" href="#item2mobile" v-if="$route.query.type == '2' || $route.query.type == '3' || $route.query.type == '4'">详情</a>
				</div>
				<div class="mui-slider-group">
					...
					<div id="item2mobile" class="mui-slider-item mui-control-content tab_box"  v-if="$route.query.type == '2' || $route.query.type == '3' || $route.query.type == '4'">
						<div class="mui-scroll-wrapper">
							<div class="mui-scroll" id="scroll2">
								<div>
									<!--遍历数据-->
									<div v-for="itemList in itemData[1].data">
	...
	watch: {
   	...
   	methods: {
   		searchData: function(){
			...
			this.noData = [{type: false},{type: false}];
			//重置上啦加载
			this.self.forEach(function(e,index){
				if(e.ele){
					e.ele.refresh(true);
   		...
   		getData: function(data, index, self, type){
   			...
   			if(_this.$route.query.grade){
				...
				if(index == '0'){
					var url = 'index.php/Home/Api/getPersonInfoByOrgId';
				}else if(index == '1'){
...
#personRank{
	...
	.mui-scroll ul.tablist {
	    background: none;
	}
	.mui-scroll ul.tablist li.tabLi {
	    padding: 0.33rem;
	}
	.tab_box .tablist li .bandge{
		line-height: 1;
    	height: auto;
	}
